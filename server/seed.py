...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        # user1 = User(username="Lucas", breed= "English Cocker Spaniel", age = 7, weight = 26, fixed=True, handler_id=1, bio="Playful, friendly, prefers large dogs" profile_pic="")
        # user2 = User(username="Gnocci", breed= "Golden Retriever", age = 3, weight = 70, fixed =True, handler_id=2, profile_pic="", bio= "Gets along with everyone")
        ...
        # user10 = User(username= "Macaroni", breed="Italian Greyhound", age=13, weight= 30, fixed=True, handler_id=10, profile_pic="", bio="Prefers to walk slowly and socialize with small dogs")
        # user11 = User(username= "Sandy", breed="West Highland Terrier", age = 4, weight = 20, fixed= True, handler_id=11, profile_pic="", bio="Lives in a pineapple, high energy")
